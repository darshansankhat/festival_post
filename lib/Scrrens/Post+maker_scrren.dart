...
class Insta_post extends StatefulWidget {
  const Insta_post({Key? key}) : super(key: key);

  @override
  State<Insta_post> createState() => _Insta_postState();
}

class _Insta_postState extends State<Insta_post> {
                  ...
                  InkWell(
                    onTap: () {
                      if (txtkey.currentState!.validate()) {
                        ...
                        Navigator.pushNamed(context, "instapost",
                            arguments: m1);
                      }
                    },
                    child: Container(
