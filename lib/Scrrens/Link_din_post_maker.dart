...
class Link_din extends StatefulWidget {
  const Link_din({Key? key}) : super(key: key);

  @override
  State<Link_din> createState() => _Link_dinState();
}

class _Link_dinState extends State<Link_din> {
                  ...
                  InkWell(
                    onTap: () {
                      if (txtkey.currentState!.validate()) {
                        ...
                        Navigator.pushNamed(context, "linkdinpost",
                            arguments: l1);
                      }
                    },
                    child: Container(
